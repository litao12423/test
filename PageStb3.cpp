// PageStb3.cpp : implementation file
//
...
CPageStb3::CPageStb3(CWnd* pParent /*=NULL*/)
	: CDialog(CPageStb3::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPageStb3)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CPageStb3::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPageStb3)
...
BEGIN_MESSAGE_MAP(CPageStb3, CDialog)
	//{{AFX_MSG_MAP(CPageStb3)
		// NOTE: the ClassWizard will add message map macros here
	//}}AFX_MSG_MAP
	ON_MESSAGE(WM_COMM_RXCHAR, OnComm)
END_MESSAGE_MAP()

LONG CPageStb3::OnComm(WPARAM ch, LPARAM port) 
{	
	static cnt_ir = 0;

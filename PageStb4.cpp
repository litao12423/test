// PageStb4.cpp : implementation file
//
...
CPageStb4::CPageStb4(CWnd* pParent /*=NULL*/)
	: CDialog(CPageStb4::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPageStb4)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CPageStb4::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPageStb4)
...
BEGIN_MESSAGE_MAP(CPageStb4, CDialog)
	//{{AFX_MSG_MAP(CPageStb4)
		// NOTE: the ClassWizard will add message map macros here
	//}}AFX_MSG_MAP
	ON_MESSAGE(WM_COMM_RXCHAR, OnComm)
END_MESSAGE_MAP()

LONG CPageStb4::OnComm(WPARAM ch, LPARAM port) 
{	
	static cnt_ir = 0;

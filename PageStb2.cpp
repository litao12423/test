// PageStb2.cpp : implementation file
//
...
CPageStb2::CPageStb2(CWnd* pParent /*=NULL*/)
	: CDialog(CPageStb2::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPageStb2)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CPageStb2::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPageStb2)
...
BEGIN_MESSAGE_MAP(CPageStb2, CDialog)
	//{{AFX_MSG_MAP(CPageStb2)
		// NOTE: the ClassWizard will add message map macros here
	//}}AFX_MSG_MAP
	ON_MESSAGE(WM_COMM_RXCHAR, OnComm)
END_MESSAGE_MAP()

LONG CPageStb2::OnComm(WPARAM ch, LPARAM port) 
{	
	static cnt_ir = 0;
